"use strict";
class Validator {
    constructor(_form, _formGroupSelector, _errorSelector, _rules) {
        this.form = _form;
    ...
    validate(inputElement, rule) {
        ...
        if (errorMessage) {
            ...
            (_b = this.getParent(inputElement, this.formGroupSelector)) === null || _b === void 0 ? void 0 : _b.addClass('error');
        }
        else {
            errorElement === null || errorElement === void 0 ? void 0 : errorElement.text('');
            (_c = this.getParent(inputElement, this.formGroupSelector)) === null || _c === void 0 ? void 0 : _c.removeClass('error');
        }
        return !!errorMessage;
    }
